<template>
  <el-card class="box-card" shadow="hover">
    ...
    <el-table
      ...
      style="width: 100%"
    >
      <el-table-column prop="ipAddr" label="ipAddr"> </el-table-column>
      <el-table-column prop="macAddr" label="macAddr"> </el-table-column>
      <el-table-column prop="ifName" label="ifName"> </el-table-column>
    </el-table>
  </el-card>
</template>
